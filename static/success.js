document.addEventListener("DOMContentLoaded", () => {
  ...
  if (data.subscriptionType === "telegram") {
    ...
    message += `
      ...
      <p> <strong>الدراسات الإجتماعية</strong>للمرحلة الإعدادية أوللمرحلة الثانوية <strong> التاريخ </strong>  لو عندك مشكلة مع مادة  </p>
      <p>  وانسى المشكلة<strong> مس إنجى سلامة على الرقم 01282410636 </strong> إحجز مع </p>
